...
public class ViewEquipos extends javax.swing.JPanel {
    ...
    private void LoadEquipos(){
        try {
            ...
            dao.listar("").forEach((u) -> model.addRow(new Object[]{
                u.getID_equipo(), u.getID_cliente(), u.getActivo(), u.getDescripcion()
            }));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Equipo", "ID_Cliente", "Activo", "Descripción"
            }
        ) {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        Dashboard.ShowJPanel(new ViewNewEquipo());
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
       ...
       DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        if (jTable1.getSelectedRows().length < 1) {
           javax.swing.JOptionPane.showMessageDialog(this,  "Debes seleccionar uno o más equipos a eliminar.\n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow()> -1) {
            try {
                ...
                DAOequipos dao = new DAOequiposImpl();
                Dashboard.ShowJPanel(new ViewNewEquipo(dao.getEquiposID(equipoID)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        }
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(equipoSearch.getText()).forEach((u) -> model.addRow(new Object[]{
                u.getID_equipo(), u.getID_cliente(), u.getActivo(), u.getDescripcion()
            }));
        } catch (Exception e) {
            System.out.println(e.getMessage());
